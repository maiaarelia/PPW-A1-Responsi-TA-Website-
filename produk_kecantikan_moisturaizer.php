...
<body>
    <div class="container">
        <h2 class="Judul-Kategori"><b>Produk Moisturaizer</b></h2>
        <div class="row">
        <?php 
            $result = mysqli_query($conn, "SELECT * FROM produk_kecantikan WHERE id_kategori = 'MSTRIZR002'");
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="card">
                    <div class="card-img-container">
                        <img src="img/moisturaizer/<?= $row['GAMBAR_PRODUK']; ?>" style="width: 200px;">
                    </div>
                    <div class="card-body">
